...
meta_title: "FastCheckout JavaScript integration step 4 - MultiSafepay Docs"
layout: 'single'
read_more: '.'
url: '/fastcheckout/javascript/step-4/'
--- 
...
href-1="/fastcheckout/javascript/step-3" header-1="Back" text-1="Step 3: Create an order" img-1="/svgs/arrow-thin-left.svg" alt-1="Left arrow" 

href-2="/api/#fastcheckout-order" header-2="Next" text-2="API reference – FastCheckout order" img-2="/svgs/arrow-thin-right.svg" alt-2="Right arrow" >}}
