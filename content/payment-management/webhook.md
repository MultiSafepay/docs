...
<details id="site-level">
  ...
  1. Go to **Websites**, and then click the relevant website.
  2. Under **Functionality** > **Webhook URL**, set your webhook endpoint.
  ...
  1. Go to **Devices** > **Terminals**.
  2. Click **Manage groups**. Go to the relevant terminal group and click **Edit**.
  3. Enter your webhook URL. Click **Save**.
</details>
