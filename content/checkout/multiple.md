...
* Return the reponse from your server to the client-side to redirect the customer.\ <br />

### Redirect the customer

You need to fetch the property payment\_url, which will then - depending on the result - redirect the customer to the correct page. This may be for 3ds required cards towards the authentication step, or for frictionless / not required 3ds, towards the success page.\
The handling of the payment\_url lies on your side.
