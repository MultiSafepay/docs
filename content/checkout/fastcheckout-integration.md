...
1. Define the FastCheckout settings:
   ...
   | `group_cards` | Whether to bundle available card payments into a single gateway: <br> - `true` (recommended): Displays a single credit card gateway <br>- `false` (default): Displays all available card payments as separate options  |
