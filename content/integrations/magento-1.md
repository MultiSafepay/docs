...
- Support for void, declined and expire status codes in combination with CANCELED STATE.
...
**Fixes**
- Canceled Orders will now actually be canceled.
...
To make the MultiSafepay Magento 1 plugin compatible with Picqer, follow two additional steps, because orders must not receive **Canceled** status.
