...
4. In your Shopify checkout, test the **MultiSafepay Payments** gateway.  
  **Note:** If using a test [API key](/websites/#site-id-api-key-and-security-code), make sure you also enable **Test mode**. 
...
5. Enter your [site ID and secure code](/websites/#site-id-api-key-and-security-code).
