...
1. Intall the MultiSafepay plugin for supporting GraphQL queries, which also installs the MultiSafepay Core, Frontend and Adminhtml plugins. For instructions, see MultiSafepay Github <a href="https://github.com/MultiSafepay/magento2-graphql" target="_blank">Magento 2 GraphQL</a>.    
