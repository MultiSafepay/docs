...
4. Enter your MultiSafepay account ID, [site ID and secure code](/websites/#site-id-api-key-and-security-code).  
...
4. Click **Edit general settings**, and then enter your [MultiSafepay site API key](/websites/#site-id-api-key-and-security-code).
...
3. Enter your [MultiSafepay site API key](/websites/#site-id-api-key-and-security-code).
