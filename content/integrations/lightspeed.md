...
6. In the **Setup** page:  
    - Enter your email address, [account ID and site API key](/websites/#site-id-api-key-and-security-code).
...
To change your [API key](/websites/#site-id-api-key-and-security-code) or environment (live or test) after installation, follow these steps:
