...
## 3. Configuration
1. Log in your backend and navigate to _Site Settings_ → _Modules_. Enable the Commerce MultiSafepay JSON module, along with the payment method modules of your choice. Then click _Save configuration_ to save the changes you have made
