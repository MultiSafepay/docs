...
---
<img src="https://raw.githubusercontent.com/MultiSafepay/docs/master/static/logo/Plugins/Magento_2.svg" width="50" align="right" style={{ margin: "20px", maxHeight: "75px" }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap' }}>
  ...
  >
    <i className="icon-external-link" /> <span>Source code</span>
  </a>
...
1. Sign in to your Magento 2 <Glossary>backend</Glossary>.
2. Go to **Stores** > **Configuration** > **MultiSafepay**.
   ...
   <details id="specific-settings">
     ...
     * Here you can configure all <Glossary>gateways</Glossary> and gift cards.
...
<details id="how-to-configure-generic-gateways">
  ...
  4. For <Glossary>BNPL</Glossary> orders, specify whether to include a shopping cart.
</details>
...
<details id="how-to-download-multiSafepay-logs">
  ...
  1. Sign in to your Magento <Glossary>backend</Glossary>.
...
The default lifetime of **Pending payment** orders in Magento 2 is 480 minutes (8 hours). For payment methods with a longer authorization period, the <Glossary>order status changes</Glossary> to **Cancelled** after 8 hours.
...
<details id="how-to-modify-order-requests">
  ...
  **ERP systems**
  ...
  For ERP systems, if the <Glossary>order status</Glossary> is **Declined**, successful payments often fail to process for orders with **Cancelled** status.

  The lifetime of bank transfers is 86400 minutes (60 days).

  The <Glossary>order status</Glossary> in Magento 2 changes to **Cancelled** before the payment can be matched to the order.
</details>
...
<details id="how-to-add-payment-links-to-order-confirmation-emails">
  ...
  **Backend emails**
  ...
  To add payment links to order confirmation emails from your Magento **<Glossary>backend</Glossary>**, you can use the `payment_link` variable and an `if/else` statement in the template.
...
[Second Chance](/docs/second-chance/) emails are sent 1 hour and 24 hours after orders are created. By default, the <Glossary>order status</Glossary> changes from **Pending payment** to **Cancelled** after 8 hours (480 minutes).
...
<details id="how-to-set-payment-link-lifetimes">
  ...
  1. Sign in to your Magento 2 <Glossary>backend</Glossary>.
  2. Go to **Stores** > **Configuration** > **MultiSafepay** > **Payment gateways**, and select the relevant <Glossary>gateway</Glossary>.
...
If you do so in your Magento 2 <Glossary>backend</Glossary>, the updated status is passed to your MultiSafepay dashboard automatically.
...
<details id="how-to-use-fooman-for-surcharges">
  ...
  **Refunds**
  ...
  You can refund orders with a Fooman surcharge applied in your MultiSafepay dashboard, but not from your Magento 2 <Glossary>backend</Glossary>.

  **BNPL orders**

  For Dutch merchants, We strongly recommend **not** applying surcharges to <Glossary>BNPL</Glossary> orders. This is now considered providing credit under the Wet op het consumentenkrediet and article 7:57 of the Burgerlijk Wetboek, and requires a permit from the Authority for Financial Markets (AFM).
...
<details id="how-to-update">
  ...
  2. Sign in to your Magento 2 <Glossary>backend</Glossary>.
