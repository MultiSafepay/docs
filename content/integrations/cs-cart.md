...
<div style={{ display: 'flex', flexWrap: 'wrap' }}>
  <a
    ...
    href="https://github.com/MultiSafepay/CS-Cart/releases/download/1.7.2/Plugin_CS-Cart_1.7.2.zip"
    target="_self"
  >
    <span>Download</span>
  ...
  <a
    ...
    href="https://github.com/MultiSafepay/CS-Cart"
    target="_blank"
  ...
  <a
    ...
    href="https://github.com/MultiSafepay/CS-Cart/blob/master/CHANGELOG.md"
    target="_blank"
    rel="noopener noreferrer"
  >
    <span>Changelog</span>
...
1. Sign in to your CS-Cart <Glossary>backend</Glossary>.
...
Extra options such as **IP-Validation** and **Debug mode** are intended for developers. Leave them unchanged.\ <br />
