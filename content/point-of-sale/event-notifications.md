...
| The payment has been initialized, but the <<glossary:card scheme>> requires authentication to continue the payment process. This is not a final status. For more information, see [Soft declines](https://docs.multisafepay.com/docs/smartpos-solutions#soft-declines) - SmartPOS solutions. | Declined (**Soft decline**)
