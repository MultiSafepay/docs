...
<table style={{textAlign:'left'}}>
  ...
  <tr>
    <td>
      <img src="https://raw.githubusercontent.com/MultiSafepay/docs/master/static/img/green-internet-signal.png" width="35" align="center" style={{padding: '5px'}} />
    </td>
  ...
  <tr>
    <td>
      <img src="https://raw.githubusercontent.com/MultiSafepay/docs/master/static/img/red-internet-signal.png" width="35" align="center" />
    </td>
...
<details id="activate-terminal">
  ...
  * [SmartPOS activation](doc:smartpos-activation)
  ...
  If your SmartPOS terminal isn't onboarded correctly, email [pos-support@multisafepay.com](mailto:pos-support@multisafepay.com)
...
* contact us via [support@multisafepay.com](mailto:support@multisafepay.com).
...
* contact us via [pos-support@multisafepay.com](mailto:pos-support@multisafepay.com)

## Google Chrome not functioning properly

If the Google Chrome app is malfunctioning, email [pos-support@multisafepay.com](mailto:pos-support@multisafepay.com) and describe your issue. If the issue is related to the current version of your Google Chrome app, follow these steps:
...
* Define the timeframe during which the logs should be uploaded to the portal and replicate the issue during this time. \_Start time\_must be later than *current time*.
* Click **release**
...
| 1000 card declined             | Contact [support@multisafepay.com](mailto:support@multisafepay.com) to confirm payment method configuration.        |
| Use Magstripe                  | Contact [pos-support@multisafepay.com](mailto:pos-support@multisafepay.com)                                         |
