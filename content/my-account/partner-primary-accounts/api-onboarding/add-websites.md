...
|notification_url <br /> `string`|The [webhook endpoint](/integration/webhooks/) for the website.  <br /> **Format**: URL (max 150 characters). Optional. |
...
|notification_url <br /> `string`|The [webhook endpoint](/integration/webhooks/) for the website.  <br /> **Format**: URL (max 150 characters). |
