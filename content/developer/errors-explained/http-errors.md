...
| HTTP 403: Forbidden | The page appears to require a login. This often occurs in a testing environment. Either remove the login page, or add our [IP-ranges](/developer/errors-explained/multisafepay-ip-ranges/) to your allow list. | 
