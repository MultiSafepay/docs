...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contained an invalid amount.
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid account ID.
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid site ID, or the site ID provided doesn’t match the account ID. 
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid secure code, or the secure code doesn't match the account ID or site ID provided. 
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid transaction ID. 
...
The `ip_address` or `forwarded_ip` parameters in the [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid customer IP address. 
...
The order description in the [create order](https://api-docs.multisafepay.com/reference/createorder) request was missing or invalid.
...
The `var1`, `var2`, or `var3` parameter in the [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid value.
...
The customer account ID in the [create order](https://api-docs.multisafepay.com/reference/createorder) request was invalid or missing.
...
The customer security code in the [create order](https://api-docs.multisafepay.com/reference/createorder) request was invalid or missing.
...
The account ID in the [create order](https://api-docs.multisafepay.com/reference/createorder) request was invalid or missing.

Check that the account ID is formatted correctly, e.g. fix typing errors and remove blank spaces.

#### Error 1016: Missing data

The [create order](https://api-docs.multisafepay.com/reference/createorder) request is missing a required data type. This error most commonly occurs when the customer is directed to a payment page, or when you generate a [payment page](/payment-pages/) link.
...
The country code in the [create order](https://api-docs.multisafepay.com/reference/createorder) request was not recognized.
...
- Ensure a payment gateway was specified in the [create order](https://api-docs.multisafepay.com/reference/createorder) request.
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains multiple currencies.
...
The [create order](https://api-docs.multisafepay.com/reference/createorder) request contains an invalid custom tax rule.
...
Some payment methods require in the [create order](https://api-docs.multisafepay.com/reference/createorder) request:
...
The price for an item in the shopping cart in the [create order](https://api-docs.multisafepay.com/reference/createorder) request is incorrect. 
...
See [List iDEAL issuers](https://api-docs.multisafepay.com/reference/listidealissuers).
