...
> **Note:** For integration based on JAVA/Android versioning, see the official Android developers site – [Threads](https://developer.android.com/guide/components/processes-and-threads).
