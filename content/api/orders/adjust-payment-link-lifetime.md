...
The lifetime of a MultiSafepay payment page session determines how long the customer can access the page and complete payment. This therefore applies to [redirect](/developer/direct-vs-redirect/) orders only.
