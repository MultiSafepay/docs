...
| currency                       | string |  The currency [ISO-4217](https://www.iso.org/iso-4217-currency-codes.html) you want the customer to pay with. Note: Currently, only Polish Złoty (PLN) and Euros (EUR) are available. |
