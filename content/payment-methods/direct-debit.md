...
|RR02|Missing debtor name or address| Repair the collection to complete the debtor's name and/or address. Contact your bank.<br> **Note:** To avoid declined transactions, non-EEA countries must include name and address in the `customer_object`. |
