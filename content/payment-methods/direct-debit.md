...
[block:parameters]
{
  "data": {
    "h-0": "Supports",
    "h-1": "Details",
    "0-0": "[Countries](/docs/payment-methods#payment-methods-by-country)",
    "0-1": "<a href=\"https://www.europeanpaymentscouncil.eu/sites/default/files/kb/file/2020-01/EPC409-09%20EPC%20List%20of%20SEPA%20Scheme%20Countries%20v2.6%20-%20January%202020.pdf\" target=\"_blank\">SEPA region</a> <i class=\"fa fa-external-link\" style=\"font-size:12px;color:#8b929e\"></i> <br> **⚠️ Note:** To avoid declined transactions, non-EEA countries must include name and address in the `customer_object`.",
    "1-0": "[Currencies](/docs/currencies/)",
    "1-1": "EUR",
    "2-0": "[Chargebacks](/docs/chargebacks/)",
    "2-1": "Yes (see below)",
    "3-0": "[Payment components](/docs/payment-components/)",
    "3-1": "Yes",
    "4-0": "[Payment pages](/docs/payment-pages/)",
    "4-1": "Yes (current and deprecated versions)",
    "5-0": "[Recurring payments](/docs/recurring-payments/)",
    "5-1": "Yes",
    "6-0": "[Refunds](/docs/refund-payments/)",
    "6-1": "Yes: Full and partial",
    "7-0": "[Second Chance](/docs/second-chance/)",
    "7-1": "Yes",
    "8-0": "[Virtual IBANs](/docs/virtual-ibans/)",
    "8-1": "Yes,  to better manage direct debits"
  },
  "cols": 2,
  "rows": 9,
  "align": [
