...
| Supports | Details |
|---|---|
| [Countries](/docs/payment-methods#payment-methods-by-country)  | Worldwide – Go to <a href="https://www.paysafecard.com/en-gb/" target="_blank">paysafecard.com</a> <i class="fa fa-external-link" style="font-size:12px;color:#8b929e"></i>, and then click the globe icon in the banner.  | 
