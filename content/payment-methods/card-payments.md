...
| [Currencies](/docs/currencies/)  | Amex: EUR, GBP, USD, CHF <br> Maestro, Mastercard, Visa: AED, AUD, BGN, BRL, CAD, CHF, CLP, CNY, COP, CZK, DKK, EUR, GBP, HKD, HRK, HUF, ILS, INR, ISK, JPY, KRW, MXN, MYR, NOK, NZD, PEN, PHP, PLN, RON, RUB, SEK, SGD, THB, TRY, TWD, UAH, USD, VEF, ZAR <br> To support additional currencies, email <support@multisafepay.com><br><br>**⚠️ Note:** Payments made with **AMEX** in CHF are settled in EUR.  | 
