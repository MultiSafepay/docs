...
Switch the gateway code in either redirect or direct transactions to "BNPL\_MF".

For *direct* transaction requests, *bank account* is no longer required.

### Plugin integrations

* Configure "BNPL\_MF" gateway.
* deactivate "PAYAFTER" gateway.

### Redirect or Components

Configure in your plugin integration "BNPL\_MF" and deactivate "PAYAFTER" gateway in the MultiSafepay Control Panel.
...
<img src="https://raw.githubusercontent.com/MultiSafepay/docs/master/static/diagrams/svg/pay-after-delivery-payment-flow.svg" alt="Pay After Delivery payment flow" style={{display: 'block', marginLeft: 'auto', marginRight: 'auto', maxWidth: '750px', width: '100%'}} />
