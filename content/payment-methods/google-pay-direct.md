...
To enable Google Pay direct for your ready-made integration, go to the payment method settings in your <Glossary>backend</Glossary> and add the merchant ID and merchant name from your <a href="https://pay.google.com/business/console/" target="_blank">Google Pay Business Console</a> <i class="fa fa-external-link" style={{ fontSize:\'12px\', color:\'#8b929e\' }}></i> .
