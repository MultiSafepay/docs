...
<img src="https://raw.githubusercontent.com/MultiSafepay/MultiSafepay-icons/master/methods/payafter-en.svg" width="100" align="right" style="margin: 20px; max-height: 75px"/> [Awaiting new logo from Jimmy]
...
<img src="https://raw.githubusercontent.com/MultiSafepay/docs/master/static/diagrams/svg/pay-after-delivery-2-payment-flow.svg" alt="Pay After Delivery payment flow" style="display: block;
  margin-left: auto;
  margin-right: auto;
  max-width: 750px;
  width: 100%;">
...
|---|---|---|
| MultiSafepay creates an invoice order. | Completed | Uncleared | 
| ❗️ Change the order status to Shipped. See [Shipment](#shipment) below. | Shipped | Uncleared |
| MultiSafepay pays you out.  | Shipped | Completed |
| The order was cancelled. | Void | Cancelled | 
| MultiSafepay declined the order. | Declined | Declined |
| You didn't ship within 30 days of the invoice order being created. | Expired | Expired | 
