...
Note: Some details are required to comply with scheme regulations. For exmaple, transactions created with payment method VISA must include correct information in the `email` parameter. 
