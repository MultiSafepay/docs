...
To help you optimize <<glossary:conversion>> and manage risk, MultiSafepay supports exemptions from 3DS2 and [strong customer authentication](/docs/psd2/) (SCA). Under the PSD2, exemptions are only supported in Europe.
...
For corporate card payments [Strong customer authentication](/docs/psd2/) (SCA) authentication is **not** required, if the following conditions are met: 
...
For more information about the exemption for secure corporate payment, see <a href="https://www.eba.europa.eu/single-rule-book-qa/-/qna/view/publicId/2018_4060" target="_blank">Regulatory Technical Standards (RTS) on strong customer authentication</a> <i class="fa fa-external-link" style="font-size:12px;color:#8b929e"></i>.

3DS2 authentication is **not** required.

- **Scope:** EEA cards only
...
3DS2 authentication is **not** required for [recurring payments](/docs/recurring-payments), whether the transaction is merchant initiated (MIT) or customer initiated (CIT).
