...
For all payment methods **except** AfterPay, you need your site's test [API key](/websites/#site-id-api-key-and-security-code).
...
1. Initiate a payment in your [ready-made integration](/integrations/) or via our API:  
    ...
    - In your backend, enter your test site [API key](/websites/#site-id-api-key-and-security-code).
...
- [Site API key](/websites/#site-id-api-key-and-security-code)
