...
**1.** In Step 2: [Construct the component object](/payment-components/single/step-2/#construct-the-component-object), change the environment from `test` to `live`:
```
...
**2.** In Step 3: [Create an order](/payment-components/single/step-3/#step-3-create-an-order), change the test endpoint to the live endpoint:  
