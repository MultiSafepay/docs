...
1. Send a [redirect](/api/#visa) API request with `locale` set to `fr_FR`.
2. On the payment page:
...
**Test a Dankort order**  

1. Send a [redirect](/api/#visa) API request with `locale` set to `da_DK`.
2. On the payment page:
    - In the **Card number** field, enter `4111111111111111`.
    - In the **Card holder** field, enter any name.
    - From the **Expiry date** lists, select any future date.
...
Testing Maestro is similar to Visa. For extensive testing, see [Visa](#details-visa-v-pay). 
