...
## Integration
To integrate Zero Authorization using our API, see API reference – [Create order](https://api-docs.multisafepay.com/reference/createorder) > Card order > `amount` parameter.
