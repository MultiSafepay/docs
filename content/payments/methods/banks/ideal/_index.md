...
childlist: '.'
intro_description: "iDEAL is the leading payment method in the Netherlands and links all major Dutch retail banks. Customers can pay via their own banking environment or mobile app, or by scanning a QR code on a screen or paper. Customers cannot reverse payment and iDEAL guarantees settlement."
layout: 'single'
