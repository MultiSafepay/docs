...
| **Payment flow**  | [Direct](/api/#request-to-pay-direct) / {{< br >}} [Redirect](/api/#request-to-pay-redirect) | [More information](/developer/api/difference-between-direct-and-redirect) |
