...
|---|---|---|---|
| 1. | The customer selects TrustPay at checkout and is redirected to a [MultiSafepay payment page](https://docs.multisafepay.com/payments/checkout/payment-pages/). | Initialized | Initialized |
| 2. | The customer authenticates their account and completes the payment. | | |
