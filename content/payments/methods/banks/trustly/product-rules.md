...
url: '/payment-methods/trustly/product-rules/'
aliases: 
...
| **Payment flow**  | [Direct](/api/#trustly---direct) / [Redirect](/api/#trustly---redirect) | [More information](/developer/api/difference-between-direct-and-redirect) |
