...
| 4. | Ship the order. {{< br >}} You **must**: {{< br >}} - Manually [change the order status to Shipped](/payments/methods/billing-suite/afterpay/user-guide/changing-order-status-to-shipped/). {{< br >}} - Ship the order to receive payment. | Shipped | Uncleared |
