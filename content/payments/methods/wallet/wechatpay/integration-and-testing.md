...
- Use [redirect](/api/#wechat-pay---redirect) orders, to redirect the customer to a [MultiSafepay payment page](/payments/checkout/payment-pages/) where the QR code is displayed under **Payment methods**.
