...
| | |
|---|---|
| **API** | [Create order](https://docs-api.multisafepay.com/reference/createorder) > Pay later order. See also Examples > AfterPay direct/redirect. |
...
| **Checkout options** | [Payment links](/payment-links/about/) – You can't adjust the lifetime. {{< br >}} [Multisafepay payment pages](/payment-pages/) – [Current version](/payment-pages/activation/) only {{< br >}} (Activate at website level in your MultiSafepay dashboard.) |
