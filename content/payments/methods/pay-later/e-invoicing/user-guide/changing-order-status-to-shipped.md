...
aliases:
    - /payments/methods/billing-suite/e-invoicing/user-guide/changing-order-status-to-shipped/
---

Changing the order status from **Completed** to **Shipped** prevents the order expiring, and triggers E-Invoicing to invoice the customer and transfer the funds to MultiSafepay. 
