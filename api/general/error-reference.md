...
**💡 Tip!** For card payments, use the [Get order](https://docs.multisafepay.com/reference/getorder) request and check the response details to learn more about the decline reason.
